...
void Draw (void)												// Draw The Scene
{
	//ROACH
	if(domulti)
		glEnable(GL_MULTISAMPLE_ARB);	//Enable our multisampleing
	//ENDROACH
	...
	for(int i=-10;i<10;i++)
		...
		{
			glPushMatrix();
			glTranslatef(i*2,j*2,-5.f);
			glRotatef(angle,0.f,0.f,1.f);
				glBegin(GL_QUADS);
				glColor3f(1.f,0.f,0.f);glVertex3f(i,j,0.f);
				glColor3f(0.f,1.f,0.f);glVertex3f(i + 2.f,j,0.f);
				glColor3f(0.f,0.f,1.f);glVertex3f(i + 2.f,j + 2.f,0.f);
				glColor3f(1.f,1.f,1.f);glVertex3f(i,j + 2.f,0.f);
				glEnd();
			glPopMatrix();
		}
