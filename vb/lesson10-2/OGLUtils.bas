...
'Revised Code Done By Jarred Capellman
...
Sub Main()
    ...
    Do While Not Done
        ...
        Else                                    ' Not Time To Quit, Update Screen
            ...
            If Keys(vbKeyPageDown) Then     ' Is the pagedown key being pressed
                If lookupdown = 50 Then     ' If your looking up 50 degrees then don't add anything
                    lookupdown = lookupdown
                Else
                    lookupdown = lookupdown + 1 ' but if your less than 50 keep adding
                End If
            End If

            If Keys(vbKeyPageUp) Then       ' Is the pageup key being pressed
                If lookupdown = -50 Then    ' If your looking down 50 degrees then don't subtract anything
                    lookupdown = lookupdown
                Else
                    lookupdown = lookupdown - 1 ' but if your more than - 50 keep subtracting
                End If
            End If
