...
'Private Constants ------------------------------------------------------------
Private Const TEXTURE_FILE As String = "Data\Crate.bmp"
Private Const NUM_TEXTURES As Integer = 3
Private Const NUM_FOG_MODES As Integer = 3
...
' All Setup For OpenGL Goes Here
  ...
  glClearColor 0.5, 0.5, 0.5, 1#      'Clear to the same color as the fog
  ...
  'Allocate space for the fog modes array
  ReDim gaFogMode(NUM_FOG_MODES)
  
  'Set up the fog modes
  gaFogMode(0) = GL_EXP
  gaFogMode(1) = GL_EXP2
  gaFogMode(2) = GL_LINEAR

  'Allocate space for and set the fog color
  ReDim gaFogColor(4)
  gaFogColor(0) = 0.5
  gaFogColor(1) = 0.5
  gaFogColor(2) = 0.5
  ...
  'Now, set up the fog effects
  glFogi fogMode, gaFogMode(giCurrFogFilter)  'Fog Mode
  glFogfv fogColor, gaFogColor(0)             'Fog Color
  glFogf fogDensity, 0.35                     'Fog Density
  glHint htFogHint, hmDontCare
  glFogf fogStart, 1#                         'Starting depth
  glFogf fogEnd, 5#                           'Ending depth
  glEnable glcFog                             'Turn on fog effects
