...
Private rtri As GLfloat                 ' Angle For The Triangle ( NEW )
Private rquad As GLfloat                ' Angle For The Quad     ( NEW )
...
' Here's Where We Do All The Drawing
    ...
    glRotatef rtri, 0#, 1#, 0#          ' Rotate The Triangle On The Y axis ( NEW )
    ...
    glTranslatef 1.5, 0#, -6#           ' Move Right 1.5 Units And Into The Screen 6.0
    glRotatef rquad, 1#, 0#, 0#         ' Rotate The Quad On The X axis ( NEW )
