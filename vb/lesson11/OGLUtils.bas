...
Public points(44, 44, 2) As Double                      ' The Array For The Points On The Grid Of Our "Wave"
Public wiggle_count As Integer                       ' Counter Used To Control How Fast Flag Waves
Public hold As GLfloat                            ' Temporarily Holds A Floating Point Value
...
' Load Bitmaps And Convert To Textures
    ...
    If LoadBMP("Data\Tim.BMP", TextureImage(), h, w) Then
...
' All Setup For OpenGL Goes Here
    ...
    glPolygonMode faceBack, pgmFILL          ' Back Face Is Filled In
    glPolygonMode faceFront, pgmLine         ' Front Face Is Drawn With Lines
    ...
    For x = 0 To 44
        ...
        For y = 0 To 44
            ...
            points(x, y, 2) = (Sin((((x / 5#) * 40#) / 360#) * 3.141592654 * 2#))
        Next y
    Next x
