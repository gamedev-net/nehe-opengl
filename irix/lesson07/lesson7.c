/*
 This code was created by Jeff Molofee '99 (ported to IRIX/GLUT by Lakmal Gunasekara '99)
 ...
 NOTE: You will see that the comments are pretty ugly in the source files. I had to 
 replace every comment of C++ style with the original c style. I used perl for this. 
 But because of the fact that I'm not so good in perl the result doesn't look very good 
 in human eyes. Nevertheless the C Compiler doesn't care 
*/
