...
//---------------------------------------------------------------------------
USEUNIT("glVector.cpp");
USEUNIT("glFont.cpp");
USEUNIT("glPoint.cpp");
USEUNIT("glCamera.cpp");
//---------------------------------------------------------------------------
#pragma argsused
					...
					int			nCmdShow)						// Window Show State
{
	...
	if (!CreateGLWindow("Lesson 44: NeHe & Vic Hollis's 3D Lens Flare Tutorial",640,480,32,fullscreen))
	{
	...
	while(!done)												// Loop That Runs While done=FALSE
	{
		...
		else													// If There Are No Messages
		{
			...
			if (keys[VK_F1])									// Is F1 Being Pressed?
			{
				...
				if (!CreateGLWindow("Lesson 44: NeHe & Vic Hollis's 3D Lens Flare Tutorial",640,480,16,fullscreen))
				{
					return 0;									// Quit If Window Was Not Created
				}
			}
