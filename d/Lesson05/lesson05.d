...
void Draw3D()
{
	...
	glBegin(GL_QUADS);						// Draw A Quad
		...
		glVertex3f( 1.0f, 1.0f, 1.0f);			// Bottom Right Of The Quad (Top)	glEnd();							// Done Drawing The Quad
...
int main(char[][] argv)
{
   ...
   CreateWindowGL(w, h, bpp, video_flags);					//Create our OpenGL Window
	...
	SDL_WM_SetCaption( "NeHe Lesson 04", "Lesson 04" );			//Set the window manager title bar
