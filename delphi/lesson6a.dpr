...
begin
  ...
  glLoadIdentity();	                                    // Reset matice
  glTranslatef(0.0,0.0,-5.0);                           // Posun do obrazovky
  glRotatef(xrot,1.0,0.0,0.0);                          // Natoèení okolo osy x
  glRotatef(yrot,0.0,1.0,0.0);                          // Natoèení okolo osy y
  glRotatef(zrot,0.0,0.0,1.0);                          // Natoèení okolo osy z
