...
uses windows, messages, opengl, arcball;
...
var
  ...
  ArcBalls: ArcBallT;                                 // Instance ArcBallu
  MousePt: Point2fT;                                  // Pozice myši
  isClicked: boolean = false;                         // Kliknuto myší?
  isRClicked: boolean = false;                        // Kliknuto pravým tlaèítkem myši?
...
begin
  ...
  gluPerspective(45.0,Width/Height,1.0,100.0);            // Výpoèet perspektivy
  glMatrixMode(GL_MODELVIEW);                             // Zvolí matici Modelview
  glLoadIdentity;                                         // Reset matice
  ArcBalls.setBounds(Width,Height);                        // Nastaví hranice pro ArcBall
end;
