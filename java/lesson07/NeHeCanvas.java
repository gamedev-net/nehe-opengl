...
Revised NeHe OpenGL tutorial Lesson 7 : Texture Filters, Lighting & Keyboard Control:
...
// GL4Java classes
   ...
   {   
     // holds information on which keys are held down.
      ...
      URL codeBase;
      boolean	light;				// Lighting ON/OFF ( NEW )
      boolean	lp;					// L Pressed? ( NEW )
      boolean	fp;					// F Pressed? ( NEW )
