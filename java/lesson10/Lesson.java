 ...
 * Date: 22/12/2001
 *
 * Port of the NeHe OpenGL Tutorial (Lesson 10: Loading And Moving Through A 3D World)
 ...
 */
   ...
   /** void start() Start the applet. */
      ...
      { 
         ...
         if(!appletMode)
            ...
            try{
               canvas.codeBase = new URL("File:///"+System.getProperty("user.dir")+"/");	
            }
   ...
   // Main method (This is what gets run when you run as an application) 
      public static void main( String args[] ) {
         ...
         Frame f = new Frame("NeHe Lesson10 - Loading And Moving Through A 3D World");
         f.add(applet);
