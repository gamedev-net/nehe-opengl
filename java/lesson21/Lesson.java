 ...
 * Date: 22/12/2001
 *
 * Port of the NeHe OpenGL Tutorial (Lesson 21: Lines, Antialiasing, Timing, Ortho View And Simple Sounds)
 ...
 */
   ...
   // Main method (This is what gets run when you run as an application) 
      public static void main( String args[] ) {
         ...
         Frame f = new Frame("NeHe Lesson21 - Lines, Antialiasing, Timing, Ortho View And Simple Sounds:");
         f.add(applet);
