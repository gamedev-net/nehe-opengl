 ...
 * Date: 22/12/2001
 *
 * Port of the NeHe OpenGL Tutorial (Lesson 22: Bump-Mapping, Multi-Texturing & Extensions:)
 ...
 */
   ...
   // Main method (This is what gets run when you run as an application) 
      public static void main( String args[] ) {
         ...
         Frame f = new Frame("NeHe Lesson22 - * Bump-Mapping, Multi-Texturing & Extensions");
         f.add(applet);
