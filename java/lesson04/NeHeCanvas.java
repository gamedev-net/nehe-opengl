...
Revised NeHe OpenGL tutorial Lesson 4 : Rotation
...
// GL4Java classes
   ...
   /** void init() Called just AFTER the GL-Context is created. */
      ...
      public void DrawGLScene()
      {
         ...
         gl.glTranslatef(1.5f,0.0f,-8.0f);						// Move Right 3 Units
         ...
         gl.glVertex3f(-1.0f,-1.0f, 0.0f);					// Bottom Left
         gl.glEnd();
         rtri+=0.4f;											// Increase The Rotation Variable For The Triangle ( NEW )
         rquad-=0.30f;										// Decrease The Rotation Variable For The Quad ( NEW )											// Done Drawing The Quad
      }
