...

{
	...
	public:
		...
		TMatrix33(double mx00, double mx01, double mx02,
		...
		// Stream
		friend std::ostream &operator<<(std::ostream &out, const TMatrix33 &o) { return o.write(out); }
		friend std::istream &operator>>(std::istream &in, TMatrix33 &o) { return o.read(in); }
