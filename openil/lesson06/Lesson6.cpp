...
#include <il\il.h>			// Header File For OpenIL
#include <il\ilu.h>			// Header File For OpenILU
#include <il\ilut.h>		// Header File For OpenILUT
...
int LoadGLTextures()									// Load Bitmaps And Convert To Textures
{
	...
	if (!ilLoadImage("Data/NeHe.oil")) {				// Load the Bitmap and Check for Errors
