...
{
	texture[0] = ilutGLLoadImage("Data/logo.oil");		// Load Image Directly Into
	texture[1] = ilutGLLoadImage("Data/mask1.oil");		//	An OpenGL Texture
	texture[2] = ilutGLLoadImage("Data/image1.oil");	//	
	texture[3] = ilutGLLoadImage("Data/mask2.oil");		//	
	texture[4] = ilutGLLoadImage("Data/image2.oil");	//	
