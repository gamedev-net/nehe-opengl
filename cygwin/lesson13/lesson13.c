...
BOOL CreateGLWindow(char* title, int width, int height, int bits, BOOL fullscreenflag)
{
	...
	static	PIXELFORMATDESCRIPTOR pfd=				// pfd Tells Windows How We Want Things To Be
	{
		...
		0,										// Select Our Color Depth, set in a non-static way.
	...
	// Must set the cColorBits member outsite the static member creation,
	// as gcc doesn't seem to like using a dynamic variable for static
	// initialization. (Hoek)
	pfd.cColorBits = bits;
