...
/* Lesson04Controller.m */

#import "Lesson04Controller.h"

@interface Lesson04Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson04Controller
...
{  
   ...
   glView = [ [ Lesson04View alloc ] initWithFrame:[ glWindow frame ]
