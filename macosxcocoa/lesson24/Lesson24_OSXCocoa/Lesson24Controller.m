...
/* Lesson24Controller.m */

#import "Lesson24Controller.h"

@interface Lesson24Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson24Controller
...
{  
   ...
   glView = [ [ Lesson24View alloc ] initWithFrame:[ glWindow frame ]
