...
/* Lesson32Controller.m */

#import "Lesson32Controller.h"

@interface Lesson32Controller (InternalMethods)
...
@implementation Lesson32Controller
...
{  
   ...
   glView = [ [ Lesson32View alloc ] initWithFrame:[ glWindow frame ]
