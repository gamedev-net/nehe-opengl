...
/* Lesson33Controller.m */

#import "Lesson33Controller.h"

@interface Lesson33Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson33Controller
...
{  
   ...
   glView = [ [ Lesson33View alloc ] initWithFrame:[ glWindow frame ]
