...
/* Lesson10Controller.m */

#import "Lesson10Controller.h"

@interface Lesson10Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson10Controller
...
{  
   ...
   glView = [ [ Lesson10View alloc ] initWithFrame:[ glWindow frame ]
