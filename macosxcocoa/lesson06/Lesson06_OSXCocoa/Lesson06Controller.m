...
/* Lesson06Controller.m */

#import "Lesson06Controller.h"

@interface Lesson06Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson06Controller
...
{  
   ...
   glView = [ [ Lesson06View alloc ] initWithFrame:[ glWindow frame ]
