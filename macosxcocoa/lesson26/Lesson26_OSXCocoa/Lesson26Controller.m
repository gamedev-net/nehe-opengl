...
/* Lesson26Controller.m */

#import "Lesson26Controller.h"

@interface Lesson26Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson26Controller
...
{  
   ...
   glView = [ [ Lesson26View alloc ] initWithFrame:[ glWindow frame ]
...
- (void) keyDown:(NSEvent *)theEvent
{
   ...
   switch( unicodeKey )
   {
      case NSRightArrowFunctionKey:
         [ glView increaseYRotSpeed ];
         break;

      case NSLeftArrowFunctionKey:
         [ glView decreaseYRotSpeed ];
         break;

      case NSDownArrowFunctionKey:
         [ glView increaseXRotSpeed ];
         break;

      case NSUpArrowFunctionKey:
         [ glView decreaseXRotSpeed ];
         break;
      ...
      case NSPageUpFunctionKey:
         [ glView increaseHeight ];
         break;

      case NSPageDownFunctionKey:
         [ glView decreaseHeight ];
         break;
   }
}  
