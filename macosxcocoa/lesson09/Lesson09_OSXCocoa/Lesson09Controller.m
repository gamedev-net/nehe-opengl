...
/* Lesson09Controller.m */

#import "Lesson09Controller.h"

@interface Lesson09Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson09Controller
...
{  
   ...
   glView = [ [ Lesson09View alloc ] initWithFrame:[ glWindow frame ]
