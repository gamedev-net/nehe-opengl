...

{
	...
	private:
		...
		TVector _Pt; // Any point on the line
	...
	public:
		...
		static TRay &invert(const TRay &r, TRay &result) { result._Pt = r._Pt; TVector::invert(r._V, result._V); return result; }
