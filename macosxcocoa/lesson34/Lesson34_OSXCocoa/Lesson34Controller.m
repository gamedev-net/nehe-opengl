...
/* Lesson34Controller.m */

#import "Lesson34Controller.h"

@interface Lesson34Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson34Controller
...
{  
   ...
   glView = [ [ Lesson34View alloc ] initWithFrame:[ glWindow frame ]
...
{ 
   ...
   {
      case ' ':
         [ glView toggleSolidPolys ];
         break;

      case NSUpArrowFunctionKey:
         [ glView increaseScaleValue ];
         break;

      case NSDownArrowFunctionKey:
         [ glView decreaseScaleValue ];
         break;
   }
}  
