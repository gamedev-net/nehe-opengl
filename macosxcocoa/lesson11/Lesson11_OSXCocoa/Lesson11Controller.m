...
/* Lesson11Controller.m */

#import "Lesson11Controller.h"

@interface Lesson11Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson11Controller
...
{  
   ...
   glView = [ [ Lesson11View alloc ] initWithFrame:[ glWindow frame ]
