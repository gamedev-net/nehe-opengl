...
/* Lesson31Controller.mm */

#import "Lesson31Controller.h"

@interface Lesson31Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson31Controller
...
{  
   ...
   glView = [ [ Lesson31View alloc ] initWithFrame:[ glWindow frame ]
