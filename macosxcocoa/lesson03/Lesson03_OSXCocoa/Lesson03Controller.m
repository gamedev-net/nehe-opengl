...
/* Lesson03Controller.m */

#import "Lesson03Controller.h"

@interface Lesson03Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson03Controller
...
{  
   ...
   glView = [ [ Lesson03View alloc ] initWithFrame:[ glWindow frame ]
