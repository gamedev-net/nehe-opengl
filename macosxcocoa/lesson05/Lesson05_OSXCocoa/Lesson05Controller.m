...
/* Lesson05Controller.m */

#import "Lesson05Controller.h"

@interface Lesson05Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson05Controller
...
{  
   ...
   glView = [ [ Lesson05View alloc ] initWithFrame:[ glWindow frame ]
