...
/* Lesson23Controller.m */

#import "Lesson23Controller.h"

@interface Lesson23Controller (InternalMethods)
- (void) setupRenderTimer;
- (void) updateGLView:(NSTimer *)timer;
- (void) createFailed;
@end

@implementation Lesson23Controller
...
{  
   ...
   glView = [ [ Lesson23View alloc ] initWithFrame:[ glWindow frame ]
