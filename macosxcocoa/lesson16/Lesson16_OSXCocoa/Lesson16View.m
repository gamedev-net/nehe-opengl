...
@interface Lesson16View (InternalMethods)
...
static GLfloat fogColor[] = { 0.5f, 0.5f, 0.5f, 1.0f };   // Fog color
       ...
       depthBits:(int)numDepthBits fullscreen:(BOOL)runFullScreen
{
   ...
   xrot = yrot = xspeed = yspeed = filter = fogfilter = 0;
   z = -5.0f;
...
- (BOOL) initGL
{
   ...
   glClearColor( 0.5f, 0.5f, 0.5f, 1.0f );   // Clear to fog color
   ...
   glFogf( GL_FOG_DENSITY, 0.35f );               // How dense the fog will be
