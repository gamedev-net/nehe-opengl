...
Module VarGlob
  ...
  use opengl_glu
    ...
    Real(GLfloat)::	rtri	! Angle For The Triangle
    Real(GLfloat)::	rquad	! Angle For The Quad
...
Subroutine DrawGLScene()
  ...
  Implicit None
	...
	call glBegin(GL_POLYGON);									! Start Drawing A Polygon
		call glColor3f(1.0_glfloat, 0.0_glfloat, 0.0_glfloat)	! Set Top Point Of Polygon To Red
		call glVertex3f(0.0_glfloat, 1.0_glfloat, 0.0_glfloat)	! First Point Of The Polygon (Triangle)
		call glColor3f(0.0_glfloat, 1.0_glfloat, 0.0_glfloat)	! Set Left Point Of Polygon To Green
		call glVertex3f(-1.0_glfloat,-1.0_glfloat, 0.0_glfloat)	! Second Point Of The Polygon
		call glColor3f(0.0_glfloat, 0.0_glfloat, 1.0_glfloat)	! Set Right Point Of Polygon To Blue
		call glVertex3f(1.0_glfloat, -1.0_glfloat, 0.0_glfloat)	! Third Point Of The Polygon
	...
	call glBegin(GL_QUADS);										! Start Drawing A Quad
		call glVertex3f(-1.0_glfloat, 1.0_glfloat, 0.0_glfloat)	! Top Left Of The Quad
		call glVertex3f( 1.0_glfloat, 1.0_glfloat, 0.0_glfloat)	! Top Right Of The Quad
		call glVertex3f( 1.0_glfloat,-1.0_glfloat, 0.0_glfloat)	! Bottom Right Of The Quad
		call glVertex3f(-1.0_glfloat,-1.0_glfloat, 0.0_glfloat)	! Bottom Left Of The Quad
