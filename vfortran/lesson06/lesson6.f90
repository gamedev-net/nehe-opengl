...
Module VarGlob
  ...
  use opengl_glu
    ...
    Real(GLfloat)::	zrot	            ! Z Rotation
    integer(GLuint) :: texture(0:1)		! Storage for 1 texture
...
subroutine LoadGLTextures()
	...
	texture1 => auxDIBImageLoad('Data/NeHe.bmp'C);
...
!	????      call PostQuitMessage(0)     ! This Sends A 'Message' Telling The Program To Quit
	...
	! Create Texture
	call glGenTextures(1_glint, texture)
...
!		// Left Face
	...
	xrot=xrot+0.3_glfloat
	yrot=yrot+0.2_glfloat
	zrot=zrot+0.4_glfloat
