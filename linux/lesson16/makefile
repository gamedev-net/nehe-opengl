...
#
all: $(basename $(wildcard lesson[1-9].c lesson1[0-9].c lesson2[0-4].c))
...
# to send to nehe.
#
dist: $(foreach file,$(basename $(wildcard lesson[1-9].c lesson1[0-9].c lesson2[0-4].c)),$(file).tar.gz)
...
distclean:
	rm $(wildcard lesson[1-9].tar.gz lesson1[0-3].tar.gz lesson18.tar.gz)
