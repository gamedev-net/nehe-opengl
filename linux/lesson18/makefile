...
LIBRARIES = -lX11 -lXi -lXmu -lglut -lGL -lGLU -lm -lstdc++ -ldl
...
#
all: $(basename $(wildcard lesson[1-9].c lesson1[0-3].c lesson18.c))
...
# to send to nehe.
#
dist: $(foreach file,$(basename $(wildcard lesson[1-9].c lesson1[0-3].c lesson18.c)),$(file).tar.gz)
